...
\begin{itmz}
\item{utilisation d’un format de fichier adapté au montage en lecture seule : \textbf{squashfs}}
\item{algorithmes de compression des données disponibles : \textbf{gzip}, \textbf{lzma}, \textbf{lzo}, \textbf{lz4}, \textbf{xz}, \textbf{zstd}}
\item{niveau supplémentaire d’encapsulation avec un format de fichier hybride : \textbf{iso}}
\end{itmz}
...
\item{garantir l’authenticité de l’image par une signature du fichier produit : \textbf{gpg}}
\end{itmz}
...
\item{si le redémarrage est différé, mise à jour du système d’exploitation en mémoire}
\item{si le redémarrage est nécessaire et critique, réduction de sa durée : \textbf{kexec-tools}}
\end{itmz}
