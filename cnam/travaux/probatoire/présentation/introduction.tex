...
\only<2>{\imgh{0.7}{11.5}{semi-learning}}
...
\only<1>{\imgh{1.5}{10.5}{training}}
\only<2>{\imgh{0.5}{12.5}{target}}
\only<3>{\imgh{0}{13.5}{regression}}
\only<4>{\imgh{0.65}{13.5}{classification}}
